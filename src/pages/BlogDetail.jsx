  ...
  return (
    <div className="min-h-screen pt-20 pb-16 bg-white dark:bg-gray-900 transition-colors duration-300">
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Back Button */}
        <Link
          to={isTransitionBlog ? "/net-to-ai" : "/blogs"}
        ...
        >
          <span>←</span> Back to {isTransitionBlog ? "Transition Journey" : "Blogs"}
        </Link>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded-lg transition-colors shadow-md"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button 
              ...
              className={`flex items-center gap-2 px-4 py-2 ${copySuccess ? 'bg-green-600' : 'bg-gray-600 hover:bg-gray-700'} text-white rounded-lg transition-colors shadow-md`}
            >
              {copySuccess ? (
                <>
